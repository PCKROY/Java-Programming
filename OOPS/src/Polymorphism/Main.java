...
//        shape.greeting();         //  Greetings!!! I am in Shapes class
        Circle circle = new Circle();
        Square square = new Square();
//        square.greeting();       // Greetings!!! I am in square class
        Triangle triangle = new Triangle();
//        triangle.greeting();    // Greetings!!! I am in Triangle class
        ...
        Shapes.greeting();          // The method cannot be overridden
